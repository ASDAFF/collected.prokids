...
<?$APPLICATION->IncludeComponent(
	...
	"banners",
	Array(
		"COLLECTPRO_LINK" => "LINK",
		"COLLECTPRO_ALONE" => "ALONE",
		"COLLECTPRO_BLANK" => "BLANK",
		"COLLECTPRO_TITLE1" => "TITLE1",
		"COLLECTPRO_TITLE2" => "TITLE2",
		"COLLECTPRO_TEXT" => "TEXT",
		"COLLECTPRO_CHANGE_SPEED" => "2000",
		"COLLECTPRO_CHANGE_DELAY" => "8000",
		"AJAX_MODE" => "N",
		...
		"COLLECTPRO_BANNER_TYPE" => "BANNER_TYPE",
		"COLLECTPRO_BANNER_HEIGHT" => "402",
		"AJAX_OPTION_ADDITIONAL" => "",
		"COLLECTPRO_BANNER_VIDEO_MP4" => "VIDEO_MP4",
		"COLLECTPRO_BANNER_VIDEO_WEBM" => "VIDEO_WEBM",
		"COLLECTPRO_BANNER_VIDEO_PIC" => "VIDEO_PIC"
	)
);?> 
...
$APPLICATION->IncludeComponent('collected:catalog.sorter', 'gopro', array(
	...
	'COLLECT_DEFAULT_TEMPLATE' => 'showcase',
	'COLLECT_CNT_TEMPLATES_0' => 'Список',
	'COLLECT_CNT_TEMPLATES_NAME_0' => 'table',
	'COLLECT_CNT_TEMPLATES_1' => 'Галерея',
	'COLLECT_CNT_TEMPLATES_NAME_1' => 'gallery',
	'COLLECT_CNT_TEMPLATES_2' => 'Витрина',
	'COLLECT_CNT_TEMPLATES_NAME_2' => 'showcase',
	'COLLECT_SORT_BY_SHOW' => 'N',
	'COLLECT_OUTPUT_OF_SHOW' => 'N',

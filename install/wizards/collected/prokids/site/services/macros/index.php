...
if(isset($wiz_site_id) && ($wiz_site_id!='s1'))
	...
	CWizardUtil::ReplaceMacros($_SERVER['DOCUMENT_ROOT'].'/bitrix/templates/'.WIZARD_TEMPLATE_ID.'/components/collected/easycart/gopro/compare.php', array('IBLOCK_ID_catalog' => $arrIBlockIDs['catalog']));
	CWizardUtil::ReplaceMacros($_SERVER['DOCUMENT_ROOT'].'/bitrix/templates/'.WIZARD_TEMPLATE_ID.'/components/collected/easycart/gopro/favorite.php', array('IBLOCK_ID_catalog' => $arrIBlockIDs['catalog']));
	CWizardUtil::ReplaceMacros($_SERVER['DOCUMENT_ROOT'].'/bitrix/templates/'.WIZARD_TEMPLATE_ID.'/components/collected/easycart/gopro/viewed_products.php', array('IBLOCK_ID_catalog' => $arrIBlockIDs['catalog']));
	...
	CWizardUtil::ReplaceMacros($_SERVER['DOCUMENT_ROOT'].'/bitrix/templates/'.WIZARD_TEMPLATE_ID.'/footer.php', array('COLLECTED_COPYRIGHTS' => GetMessage('COLLECTED_COPYRIGHTS')));

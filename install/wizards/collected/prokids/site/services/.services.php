...
$arServices = Array(
	...
	'module_developkit' => array(
		'NAME' => GetMessage('SERVICE_STEP_INSTALL_MODULE').': '.GetMessage('SERVICE_STEP_INSTALL_MODULE_DEVELOPKIT'),
		'STAGES' => array(
			'index.php',
		),
		'MODULE_ID' => 'main',
	),
	'module_devlibrary' => array(
		'NAME' => GetMessage('SERVICE_STEP_INSTALL_MODULE').': '.GetMessage('SERVICE_STEP_INSTALL_MODULE_DEVLIBRARY'),
		'STAGES' => array(
			'index.php',
		),
		'MODULE_ID' => 'main',

...
$adaptive = COption::GetOptionString('collected.proopt', 'adaptive', 'Y');
$prop_option = COption::GetOptionString('collected.proopt', 'prop_option', 'line_through');
		...
		?><div id="tpanel" class="tpanel"><?
			?><div class="centering"><?
				?><div class="centeringin clearfix"><?
					...
					$APPLICATION->IncludeComponent("collected:autodetect.location", "inheader", array(

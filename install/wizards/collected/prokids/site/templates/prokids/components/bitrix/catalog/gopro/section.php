...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"COLLECT_CHOSE_TEMPLATES_SHOW" => "Y",
		"COLLECT_CNT_TEMPLATES" => ( isset($arParams["SORTER_CNT_TEMPLATES"]) ? $arParams["SORTER_CNT_TEMPLATES"] : '3' ),
		"COLLECT_DEFAULT_TEMPLATE" => $arParams["SORTER_DEFAULT_TEMPLATE"],
		"COLLECT_CNT_TEMPLATES_0" => $arParams["SORTER_TEMPLATE_NAME_3"],
		"COLLECT_CNT_TEMPLATES_NAME_0" => "table",
		"COLLECT_CNT_TEMPLATES_1" => $arParams["SORTER_TEMPLATE_NAME_2"],
		"COLLECT_CNT_TEMPLATES_NAME_1" => "gallery",
		"COLLECT_CNT_TEMPLATES_2" => $arParams["SORTER_TEMPLATE_NAME_1"],
		"COLLECT_CNT_TEMPLATES_NAME_2" => "showcase",
		"COLLECT_SORT_BY_SHOW" => ( $arParams['SORTER_OFF_SORT_BY']=='Y' ? 'N' : 'Y' ),
		...
		"COLLECT_OUTPUT_OF_SHOW" => ( $arParams['SORTER_OFF_OUTPUT_OF_SHOW']=='Y' ? 'N' : 'Y' ),
		"COLLECT_OUTPUT_OF" => $arOutupVariables,
		"COLLECT_OUTPUT_OF_DEFAULT" => ( isset($arParams["SORTER_OUTPUT_OF_DEFAULT"]) ? $arParams["SORTER_OUTPUT_OF_DEFAULT"] : '15' ),
		"COLLECT_OUTPUT_OF_SHOW_ALL" => "N",
		"COLLECT_DONT_REDIRECT" => "Y",
...
if($IS_AJAXPAGES=='Y' || $IS_SORTERCHANGE=='Y')
{
	...
	die();
			...
			?></div><?
				?><div class="bottom"><?
$APPLICATION->IncludeComponent('collected:catalog.sorter', 'gopro', array(
	'COLLECT_ACTION_PARAM_NAME' => 'collectaction',
	'COLLECT_ACTION_PARAM_VALUE' => 'collectvalue',
	'COLLECT_CHOSE_TEMPLATES_SHOW' => 'N',
	'COLLECT_SORT_BY_SHOW' => 'N',

...
?><div class="catalogsorter" id="composite_sorter"<?if(isset($arParams['AJAXPAGESID']) && $arParams['AJAXPAGESID']!=''):?> data-ajaxpagesid="<?=$arParams['AJAXPAGESID']?>"<?endif;?>><?
	...
	?><div class="sortaou clearfix"><?
		...
		{
			?><div class="<?if($arParams['COLLECT_SHORT_SORTER']=='Y'):?>shortsort<?else:?>sort<?endif;?> clearfix"><?
				?><span class="cool"><?
		...
		if($arParams['COLLECT_OUTPUT_OF_SHOW']=='Y' && $arParams['COLLECT_CHOSE_TEMPLATES_SHOW']!='Y')
		{

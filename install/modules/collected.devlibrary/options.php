...
if((isset($_REQUEST['save']) || isset($_REQUEST['apply'])) && check_bitrix_sessid())
{
	...
	UnRegisterModuleDependences('iblock', 'OnAfterIBlockElementAdd', 'collected.devlibrary', 'CollectDevLibOffersExtension', 'HandlerOnAfterIBlockElementAddOrUpdateFakePrice');
	UnRegisterModuleDependences('iblock', 'OnAfterIBlockElementUpdate', 'collected.devlibrary', 'CollectDevLibOffersExtension', 'HandlerOnAfterIBlockElementAddOrUpdateFakePrice');
	if($_REQUEST['fakeprice_active']=="Y")
	{
		RegisterModuleDependences('iblock', 'OnAfterIBlockElementAdd', 'collected.devlibrary', 'CollectDevLibOffersExtension', 'HandlerOnAfterIBlockElementAddOrUpdateFakePrice',10000);
		RegisterModuleDependences('iblock', 'OnAfterIBlockElementUpdate', 'collected.devlibrary', 'CollectDevLibOffersExtension', 'HandlerOnAfterIBlockElementAddOrUpdateFakePrice',10000);
	}

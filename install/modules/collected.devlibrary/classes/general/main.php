...
class CollectDevLib
{
	public static function Init($arInit)
	{
		...
		{
			$APPLICATION->AddHeadString("<script>var CollectDevLib_BasketEndWord_end1 = \"".GetMessage("RSDF_END_1")."\";var CollectDevLib_BasketEndWord_end2 = \"".GetMessage("RSDF_END_2")."\";var CollectDevLib_BasketEndWord_end3 = \"".GetMessage("RSDF_END_3")."\";</script>");

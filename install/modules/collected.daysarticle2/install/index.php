...
Class collected_daysarticle2 extends CModule
{
	...
	function InstallEvents()
	{
		...
		RegisterModuleDependences('sale', 'OnOrderUpdate', 'collected.daysarticle2', 'CRSDA2Main', 'OnOrderUpdate');
		return TRUE;
	}
	...
	function UnInstallEvents()
	{
		...
		UnRegisterModuleDependences('sale', 'OnOrderUpdate', 'collected.daysarticle2', 'CRSDA2Main', 'OnOrderUpdate');
		return TRUE;
	}
